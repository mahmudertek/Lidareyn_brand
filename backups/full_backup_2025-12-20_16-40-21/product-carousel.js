...
function initProductCarousel() {
    ...
    const products = [
        ...
        { id: 25, name: 'Madeniyat 185mm Daire Testere', price: '3,499.00TL', image: 'https://placehold.co/300x200/D4AF37/1a1a1a?text=Madeniyat+Testere', badge: '', link: 'urun-detay.html?id=25' },
        { id: 26, name: 'Milwaukee M12 FUEL Darbe Vidalama', price: '5,499.00TL', image: 'https://placehold.co/300x200/6b9bd8/ffffff?text=Milwaukee+M12', badge: 'Yeni', link: 'urun-detay.html?id=26' },
        { id: 27, name: 'DeWalt DWS780 Gönye Kesme Testeresi', price: '18,999.00TL', image: 'https://placehold.co/300x200/a29bfe/ffffff?text=DeWalt+Gonye', badge: 'Premium', link: 'urun-detay.html?id=27' },
        { id: 28, name: 'Stanley 47 Parça Tornavida Seti', price: '899.00TL', image: 'https://placehold.co/300x200/74b9ff/ffffff?text=Stanley+Tornavida', badge: '', link: 'urun-detay.html?id=28' },
        { id: 29, name: 'Fisco 5m Profesyonel Lazer Metre', price: '2,199.00TL', image: 'https://placehold.co/300x200/9b8fd8/ffffff?text=Fisco+Lazer', badge: '', link: 'urun-detay.html?id=29' },
        { id: 30, name: 'Bosch GSR 18V-50 Profesyonel Matkap', price: '5,999.00TL', image: 'https://placehold.co/300x200/8ba9d8/ffffff?text=Bosch+GSR', badge: 'Çok Satan', link: 'urun-detay.html?id=30' },
        { id: 31, name: 'Makita DF333D 12V Max Matkap', price: '3,299.00TL', image: 'https://placehold.co/300x200/8b7bd8/ffffff?text=Makita+DF333', badge: '', link: 'urun-detay.html?id=31' },
        { id: 32, name: 'Knipex VDE 1000V İzoleli Pense Seti', price: '3,999.00TL', image: 'https://placehold.co/300x200/6b9bd8/ffffff?text=Knipex+VDE', badge: 'Güvenlik', link: 'urun-detay.html?id=32' },
        { id: 33, name: 'Beta 2001/C Safety Helmet', price: '599.00TL', image: 'https://placehold.co/300x200/a29bfe/ffffff?text=Beta+Helmet', badge: '', link: 'urun-detay.html?id=33' },
        { id: 34, name: 'ASKA 125mm Avuç Taşlama 1200W', price: '1,899.00TL', image: 'https://placehold.co/300x200/8b7bd8/ffffff?text=ASKA+Taslama', badge: 'Yeni', link: 'urun-detay.html?id=34' },
        { id: 35, name: 'Madeniyat Profesyonel 200 Parça Set', price: '8,999.00TL', image: 'https://placehold.co/300x200/D4AF37/1a1a1a?text=Madeniyat+Set', badge: 'Premium', link: 'urun-detay.html?id=35' },
        { id: 36, name: 'Izeltaş Premium Tornavida Seti', price: '449.00TL', image: 'https://placehold.co/300x200/74b9ff/ffffff?text=Izeltas+Tornavida', badge: '', link: 'urun-detay.html?id=36' }
    ];

    // Configuration
    const PRODUCTS_PER_PAGE = 18; // 3 rows x 6 columns
    let currentPage = 0;
