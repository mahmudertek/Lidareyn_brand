...
# Source header content from index.html (I will hardcode it based on my previous read)
NEW_HEADER = """    <header class="main-header" role="banner">
...
for filename in TARGET_FILES:
    ...
    try:
        ...
        # 1. Replace Header
        # Regex to find the part between <header ...> and </header>
        # We assume the header tag has class="main-header"
