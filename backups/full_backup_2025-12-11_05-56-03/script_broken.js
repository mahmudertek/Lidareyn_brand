...
const Storage = {
    getCart: () => JSON.parse(localStorage.getItem('resels_cart')) || [],
    saveCart: (cart) => localStorage.setItem('resels_cart', JSON.stringify(cart)),
    getFavorites: () => JSON.parse(localStorage.getItem('resels_favorites')) || [],
    saveFavorites: (favs) => localStorage.setItem('resels_favorites', JSON.stringify(favs))
};
