...
const categoriesData = {
    ...
    'baglanti-ve-sabitleme': {
        ...
        icon: 'fa-link',
        image: 'gorseller/category_baglanti_sabitleme.png',
        subcategories: [
    ...
    'hortumlar-baglanti': {
        ...
        icon: 'fa-faucet',
        image: 'gorseller/category_hortumlar.png',
        subcategories: [
    ...
    'otomobil-motosiklet': {
        ...
        icon: 'fa-car-side',
        image: 'gorseller/category_otomobil_motosiklet.png',
        subcategories: [
    ...
    'yalitim-ve-kaplama': {
        ...
        icon: 'fa-layer-group',
        image: 'gorseller/category_yalitim_kaplama.png',
        subcategories: [
    ...
    'nalburiye-baglanti-elemanlari': {
        ...
        icon: 'fa-link',
        image: 'gorseller/category_nalburiye_baglanti.png',
        subcategories: [
    ...
    'boyalar-boya-malzemeleri': {
        ...
        image: 'gorseller/category_boya.png',
        subcategories: [
    ...
    'kapi-pencere-cerceve': {
        ...
        icon: 'fa-door-open',
        image: 'gorseller/category_kapi_pencere.png',
        subcategories: [
