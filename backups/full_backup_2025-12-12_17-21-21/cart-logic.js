...
const Storage = {
    getCart: () => JSON.parse(localStorage.getItem('karakoytuccari_cart')) || [],
    saveCart: (cart) => localStorage.setItem('karakoytuccari_cart', JSON.stringify(cart)),
    getFavorites: () => JSON.parse(localStorage.getItem('karakoytuccari_favorites')) || [],
    saveFavorites: (favs) => localStorage.setItem('karakoytuccari_favorites', JSON.stringify(favs))
};
