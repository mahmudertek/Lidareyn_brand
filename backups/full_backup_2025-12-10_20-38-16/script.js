...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (elements.searchBtn) {
        ...
        elements.searchBtn.addEventListener('click', (e) => {
            ...
            // If already open and has value, search?
            // Usually search icon just opens the bar. Another click or Enter triggers search.
            // Let's rely on Enter for now or add a separate search trigger button inside the container if needed.
            // But for this simple UI, maybe the icon acts as toggle.
        });
