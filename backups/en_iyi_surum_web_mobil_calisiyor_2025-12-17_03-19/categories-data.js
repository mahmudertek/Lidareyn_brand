...
const categoriesData = {
    ...
    'nalbur-yapi-malzemeleri': {
        ...
        subcategories: [
            ...
            // Removed Boya & İzolasyon column content as requested
            { name: 'Donanım', items: ['Kilitler ve Menteşeler'], icon: 'fa-lock' }
        ]
    },

    // 'hortumlar-baglanti': REMOVED as per user request (implied by "Hortumlar ve Bağlantı Parçaları")
    ...
    // 'otomobil-motosiklet': REMOVED as per user request
    ...
    // 'yalitim-ve-kaplama': REMOVED as per user request

    // 'nalburiye-baglanti-elemanlari': REMOVED as per user request
    ...
    // 'boyalar-boya-malzemeleri': REMOVED as per user request

    // 'kapi-pencere-cerceve': REMOVED as per user request
    ...
    // Adding back missing category from Desktop Menu if needed, but only cleaning up requests now.
    'elektrikli-el-aletleri': {
        ...
        subcategories: [
            { name: 'Delme & Vidalama', items: ['Akülü Vidalama', 'Darbeli Matkap', 'Kırıcı Delici'], icon: 'fa-screwdriver' },
            { name: 'Kesme & Taşlama', items: ['Avuç Taşlama', 'Dekupaj Testere', 'Daire Testere'], icon: 'fa-fan' },
            { name: 'Zımpara & Polisaj', items: ['Eksantrik Zımpara', 'Tank Zımpara', 'Polisaj Makinesi'], icon: 'fa-stroopwafel' }
        ]
    },
    'elektronik-aksesuar': {
